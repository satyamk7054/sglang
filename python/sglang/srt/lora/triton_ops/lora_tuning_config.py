...
Config file naming: lora_{kernel},K={K},R={R},device={device}.json
Where kernel is "shrink" or "expand", K is input_dim, R is max_rank.
...
def get_lora_config_file_name(
    ...
    return f"lora_{kernel},K={K},R={R},device={device_name}.json"
